...
```sh
kubectl apply --server-side -f https://github.com/minefleet/minecraft-gateway/releases/download/<tag>/install.yaml
```
...
```sh
make build-installer IMG=<some-registry>/minecraft-gateway:tag
```
